...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20230517122859_mig34")]
    partial class mig34
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EntityLayer.Concrete.AdminStudentClasses", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EntityLayer.Concrete.Student", b =>
                {
                    ...
                    b.Property<int?>("AdminStudentClassesId")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("StudentClassesClassesId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AdminStudentClassesId");

                    b.HasIndex("AppUserId");

                    b.HasIndex("StudentClassesClassesId");

                    b.ToTable("Students");
                });

            modelBuilder.Entity("EntityLayer.Concrete.StudentClasses", b =>
                {
            ...
            modelBuilder.Entity("EntityLayer.Concrete.Student", b =>
                {
                    b.HasOne("EntityLayer.Concrete.AdminStudentClasses", null)
                        .WithMany("Students")
                        .HasForeignKey("AdminStudentClassesId");
                    ...
                    b.HasOne("EntityLayer.Concrete.StudentClasses", null)
                        .WithMany("Students")
                        .HasForeignKey("StudentClassesClassesId");
